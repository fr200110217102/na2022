...
template <class type>
class _0_2D : public Function_2D<type>{
public:
	virtual type operator ()(const type& x, const type& y) const {return 0;}
	virtual type partial(const type& x, const type& y, const int& i, const int& j) const {return 0;}
};
#endif